      ...
      <div class="app-container">
        <div class="filter-container">
          <div class="filter-item-left">
            <el-button class="filter-item" type="primary" @click="handleDialogShow('PrivilegeEdit', 'add')">
              新增特权
            </el-button>
          </div>
        </div>
        ...
        <el-table v-loading="listLoading" :data="list" border fit highlight-current-row>
          ...
          <el-table-column label="操作" align="center" width="160" class-name="small-padding fixed-width">
            <template #default="{ row, $index }">
              <el-button size="small" type="danger" @click="handleDialogShow('PrivilegeEdit', 'edit', row)">
                编辑
              </el-button>
...
import { getPrivilegeList, editPrivilege, delPrivilege } from '/@/api/finance-manage/privilegeSettings.js'
...
export default {
  ...
  data() {
    return {
      ...
      dialogLoading : false,
      switchLoading : false,
      currentComponent : 'PrivilegeEdit',
      mode : 'add',
      currentRowData : {},
      listLoading : false,
      list : [],
