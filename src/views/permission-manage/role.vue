<template>
  <YuLayout title="">
    <template #body>
      <div class="app-container">
        ...
        <el-table v-loading="listLoading" :data="list" border fit highlight-current-row>
          ...
          <el-table-column label="角色描述" prop="status" align="center" />
          <el-table-column label="拥有权限" prop="status" align="center" />
          <el-table-column label="员工数量" prop="status" align="center" />
    ...
    >
      ...
      <role-edit v-if="currentComponent" :mode="mode"></role-edit>
      <template #footer>
