<template>
  <YuLayout title="">
    <template #body>
      <div class="app-container">
        ...
        <el-table v-loading="listLoading" :data="list" border fit highlight-current-row>
          <el-table-column label="登录账号/手机号" prop="id" align="center" />
          <el-table-column label="所属角色" prop="status" align="center" />
          <el-table-column label="备注信息" prop="status" align="center" />
          <el-table-column label="创建时间" prop="status" align="center" />
    ...
    >
      ...
      <account-edit v-if="currentComponent" :mode="mode"></account-edit>
      <template #footer>
        <span class="dialog-footer">
          <el-button v-loading="dialogLoading" size="large" type="primary" @click="submit">确认</el-button>
        </span>
      </template>
    </el-dialog>
  </YuLayout>
