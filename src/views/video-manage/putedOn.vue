      ...
      <div class="app-container">
        <div class="filter-container">
          <div class="filter-item-left">
            ...
            <el-button class="filter-item" type="primary" @click="handlePutOn('muti')"> 下架 </el-button>
          </div>
...
:key="item.tagId"
          ...
          <el-table-column label="推荐排序" prop="priority" align="center"></el-table-column>
          ...
          <el-table-column label="操作" fixed="right" align="center" width="140" class-name="small-padding fixed-width">
            <template #default="{ row, $index }">
              <el-button size="small" type="danger" @click="handlePutOn('single', row, $index)"> 下架 </el-button>
...
import { getVideoList, deleteUploadedVideo, videoPutOn, getM3u8 } from '/@/api/video-manage/pulledOff.js'
...
export default {
  ...
  data() {
    return {
      ...
      topicOptions : [{ key : '10', display_name : '专题1' }],
      tagOptions : [
  ...
  methods : {
    ...
    handleDialogShow( type, row = {} ) {
      if ( type === 'PutedOnEdit' && this.multipleSelection.length === 0 ) {
        ElMessage( {
          message : '请选择需要调整的视频',
          type : 'error'
        } )
