<template>
  <YuLayout title="">
      ...
      <div class="app-container">
        <div class="filter-container">
          <div class="filter-item-left">
            <el-button class="filter-item" type="primary" @click="handleEdit('add')"> 添加播放标签 </el-button>
          </div>
        </div>

        <el-table v-loading="listLoading" :data="list" border fit highlight-current-row>
          <el-table-column label="ID" prop="tagId" align="center" />
    ...
    <el-dialog
      ...
      :title="dialogTitle"
    >
      <tag-edit ref="dialog" v-if="dialogVisible" :mode="mode" :current-row-data="currentRowData"></tag-edit>
      <template #footer>
...
import { getVideoTagList, deleteVideoTag, editVideoTag, apiSetStatus } from '/@/api/video-manage/tag.js'
